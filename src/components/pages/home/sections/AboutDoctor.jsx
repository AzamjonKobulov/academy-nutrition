  ...
  return (
    <section className="bg-brand-cream">
      <div className="container mx-auto grid md:grid-cols-2 gap-30px px-30px">
        <div className="md:space-y-8 order-2 md:order-1">
          ...
          <div className="space-y-30px">
            ...
            <Button
              variant="primary"
              className="w-full sm:w-auto h-[77px] text-lg 2xl:text-22 font-medium rounded-full px-6 lg:px-11"
            >
        ...
        <div className="space-y-8 md:space-y-0 order-1 md:order-2">
          ...
          <div className="space-y-5 sm:space-y-30px lg:space-y-10 bg-white rounded-2xl lg:rounded-30px py-8 lg:py-[60px] px-5 lg:px-6 2xl:px-10">
            <img
              src="/assets/images/img-tile-about-doctor.png"
              alt="Image"
              className="w-60 h-8 lg:w-[294px] lg:h-10 2xl:w-[348px] 2xl:h-12 mx-auto"
            />

            <ul className="list-disc space-y-3.5 lg:space-y-5 text-sm sm:text-base 2xl:text-22 leading-5 sm:leading-6 lg:leading-8 pl-5 lg:pl-8">
