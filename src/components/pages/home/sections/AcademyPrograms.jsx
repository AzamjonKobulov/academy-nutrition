            ...
            >
              <div className="space-y-5 lg:space-y-30px 3xl:space-y-10">
                ...
                <div className="flex items-center gap-2.5 sm:gap-6">
                  <div className="text-center border border-brand-gray rounded-full px-7 py-3 3xl:px-9 3xl:py-5">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-30px sm:gap-10 lg:gap-16 xl:gap-10 mt-16 sm:mt-24 lg:mt-[150px] 3xl:mt-[200px]">
          ...
          <div className="max-w-[1052px] grid sm:grid-cols-2 gap-5 sm:gap-y-10 lg:gap-10">
            ...
            <div className="space-y-5 sm:space-y-10 lg:space-y-10">
              {/* Learning Block 1 */}
              <div className="bg-brand-cream min-h-80 sm:min-h-[400px] md:min-h-80 lg:min-h-[356px] 3xl:min-h-[444px] flex flex-col justify-between gap-10 rounded-2xl lg:rounded-22px 3xl:rounded-30px p-5 sm:p-30px lg:p-10">
                <div className="flex sm:flex-col-reverse md:flex-row items-start justify-between gap-6">
                  <h3 className="text-lg xs:text-2xl sm:text-22 md:text-22 3xl:text-3xl font-bold leading-6 xs:leading-8 sm:leading-6 3xl:leading-8">
              ...
              {/* Learning Block 2 */}
              <div className="bg-white min-h-80 sm:min-h-[400px] md:min-h-80 lg:min-h-[356px] 3xl:min-h-[444px] flex flex-col justify-between gap-10 rounded-2xl lg:rounded-22px 3xl:rounded-30px p-5 sm:p-30px lg:p-10">
                <div className="flex sm:flex-col-reverse md:flex-row items-start justify-between gap-6">
                  <h3 className="text-lg xs:text-2xl sm:text-22 md:text-22 3xl:text-3xl font-bold leading-6 xs:leading-8 sm:leading-6 3xl:leading-8">
              ...
              <div
                className={`${
                  idx === 0 || idx === 3 || idx === 4
                    ? "bg-brand-cream"
                    : "bg-white"
                } min-h-80 lg:min-h-[356px] 3xl:min-h-[444px] flex flex-col justify-between rounded-2xl lg:rounded-22px 3xl:rounded-30px p-5 sm:p-30px lg:p-10`}
                key={idx}
              >
                <div className="flex sm:flex-col-reverse md:flex-row items-start justify-between gap-6">
                  <h3 className="text-lg sm:text-[1.375rem] 3xl:text-3xl font-bold">
                ...
                <p className="text-sm sm:text-base lg:text-lg 3xl:text-22 leading-5 sm:leading-6 3xl:leading-8`">
                  {learn.text}
                </p>
              </div>
            ))} */}
