...
const programs = [
  ...
  },
  {
    ...
    img: "/assets/images/img-academy-program-2.png",
  },
  {
    num: 3,
    title:
    ...
    img: "/assets/images/img-academy-program-3.png",
  },
  {
    num: 4,
    ...
    img: "/assets/images/img-academy-program-4.png",
  },
];
  ...
  return (
    <section className="bg-brand-primary">
      <div className="container mx-auto px-30px">
        ...
        <div className="space-y-5 sm:space-y-30px lg:space-y-10 2xl:space-y-16">
          {programs.map((prog) => (
            <div
              key={prog.num}
              className="flex flex-col-reverse lg:flex-row gap-30px sm:gap-10 xl:gap-16 2xl:gap-20 bg-white rounded-2xl lg:rounded-22px 2xl:rounded-30px px-5 py-30px sm:p-30px lg:p-10 2xl:p-12"
            >
        ...
        {/* What will you learn? */}
        <div className="flex flex-col lg:flex-row justify-between gap-30px sm:gap-10 lg:gap-16 xl:gap-10 mt-16 sm:mt-24 lg:mt-[150px] 2xl:mt-[200px]">
          <h2 className="text-white mb-30px sm:mb-10 lg:mb-16 2xl-mb-20">
            Что вы <br className="hidden 2xl:block" /> узнаете
          </h2>
          ...
          <div className="max-w-[1052px] grid sm:grid-cols-2 gap-5 sm:gap-y-10 lg:gap-10">
            ...
            <div className="space-y-5 sm:space-y-10 lg:space-y-10">
              {/* Learning Block 1 */}
              <div className="bg-brand-cream min-h-80 sm:min-h-[400px] md:min-h-80 lg:min-h-[356px] 2xl:min-h-[444px] flex flex-col justify-between gap-10 rounded-2xl lg:rounded-22px 2xl:rounded-30px p-5 sm:p-30px lg:p-10">
                <div className="flex sm:flex-col-reverse md:flex-row items-start justify-between gap-6">
                  <h3 className="text-lg xs:text-2xl sm:text-22 md:text-22 2xl:text-3xl font-bold leading-6 xs:leading-8 sm:leading-6 2xl:leading-8">
                ...
                <p className="text-sm xs:text-lg sm:text-base lg:text-lg 2xl:text-22 leading-5 sm:leading-6 2xl:leading-8">
              ...
              {/* Learning Block 2 */}
              <div className="bg-white min-h-80 sm:min-h-[400px] md:min-h-80 lg:min-h-[356px] 2xl:min-h-[444px] flex flex-col justify-between gap-10 rounded-2xl lg:rounded-22px 2xl:rounded-30px p-5 sm:p-30px lg:p-10">
                <div className="flex sm:flex-col-reverse md:flex-row items-start justify-between gap-6">
                  <h3 className="text-lg xs:text-2xl sm:text-22 md:text-22 2xl:text-3xl font-bold leading-6 xs:leading-8 sm:leading-6 2xl:leading-8">
            ...
            {/* Right Blocks */}
            <div className="flex flex-col items-stretch space-y-5 sm:space-y-10 lg:space-y-10 sm:mt-16 2xl:mt-32">
              {/* Learning Block 1 */}
              <div className="bg-white min-h-80 sm:min-h-[400px] md:min-h-80 lg:min-h-[356px] 2xl:min-h-[444px] flex flex-col justify-between gap-10 rounded-2xl lg:rounded-22px 2xl:rounded-30px p-5 sm:p-30px lg:p-10">
                <div className="flex sm:flex-col-reverse md:flex-row items-start justify-between gap-6">
                  <h3 className="text-lg xs:text-2xl sm:text-22 md:text-22 2xl:text-3xl font-bold leading-6 xs:leading-8 sm:leading-6 2xl:leading-8">
              ...
              <div
                className={`${
                  idx === 0 || idx === 3 || idx === 4
                    ? "bg-brand-cream"
                    : "bg-white"
                } min-h-80 lg:min-h-[356px] 2xl:min-h-[444px] flex flex-col justify-between rounded-2xl lg:rounded-22px 2xl:rounded-30px p-5 sm:p-30px lg:p-10`}
                key={idx}
              >
                <div className="flex sm:flex-col-reverse md:flex-row items-start justify-between gap-6">
                  <h3 className="text-lg sm:text-[1.375rem] 2xl:text-3xl font-bold">
                  ...
                  <img src={learn.icon} alt={learn.title} />
                </div>

                <p className="text-sm sm:text-base lg:text-lg 2xl:text-22 leading-5 sm:leading-6 2xl:leading-8`">
                  {learn.text}
                </p>
              </div>
            ))} */}
