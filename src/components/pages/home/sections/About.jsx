    ...
    <section className="bg-brand-cream">
      <div className="container mx-auto relative flex flex-col md:flex-row space-y-5 px-30px">
        ...
        <div className="space-y-5 md:space-y-10 lg:space-y-16 3xl:space-y-20 left-0 top-0">
          ...
          {/* Blocks */}
          <div className="md:max-w-lg lg:max-w-2xl 3xl:max-w-4xl relative z-10 grid xs:grid-cols-2 gap-5 lg:gap-30px text-sm leading-5 sm:text-base sm:leading-6 3xl:text-22 3xl:leading-8 md:pb-20 md:pr-11 lg:pr-3 3xl:pr-8">
            {/* Block 1 */}
            <div className="min-h-[210px] sm:min-h-[230px] 3xl:min-h-[304px] flex flex-col justify-between items-start bg-white rounded-2xl 3xl:rounded-22px p-5 3xl:p-30px">
              <img
                src="/assets/images/img-blocks-1.svg"
                alt="Image"
                className="w-[150px] h-11 lg:w-[193px] lg:h-[58px] 3xl:w-auto 3xl:h-auto"
              />
