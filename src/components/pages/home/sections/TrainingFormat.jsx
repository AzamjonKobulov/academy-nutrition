  ...
  return (
    <section className="">
      <div className="container mx-auto px-30px">
        ...
        <div className="space-y-30px sm:space-y-10 2xl:space-y-40">
          {/* Blocks */}
          <div className="space-y-30px sm:space-y-10 lg:space-y-16 2xl:space-y-20 mt-30px sm:mt-10 lg:mt-16 2xl:mt-20">
            {/* Block 1 */}
            <div className="flex flex-col sm:flex-row gap-30px sm:gap-10 lg:gap-16 2xl:gap-20 bg-brand-cream rounded-2xl lg:rounded-22px 2xl:rounded-30px  p-5 sm:p-30px lg:p-10 2xl:p-12">
              <div className="space-y-3.5 sm:space-y-5 lg:space-y-8 2xl:space-y-10">
                <h3>Мини-группа</h3>

                <ul className="space-y-3.5 sm:space-y-4 lg:space-y-6 2xl:space-y-8">
                  {list.map((l) => (
                    <li
                      key={l}
                    ...
                    >
                      <svg
                        ...
                        className="size-5 sm:size-7 2xl:size-8 shrink-0"
                      >
                        <circle
                          cx="17.0018"
                          cy="18.1337"
            ...
            {/* Block 2 */}
            <div className="flex flex-col sm:flex-row lg:items-center gap-30px sm:gap-10 lg:gap-16 2xl:gap-20 bg-brand-cream rounded-2xl lg:rounded-22px 2xl:rounded-30px  p-5 sm:p-30px lg:p-10 2xl:p-12">
              {/* Image */}
              <div className="sm:w-[220px] sm:h-[209px] lg:w-1/2 lg:h-auto shrink-0 rounded-2xl lg:rounded-30px overflow-hidden">
                <img
          ...
          <div className="relative flex flex-col md:flex-row justify-between md:items-center md:justify-end md:gap-30px lg:gap-10 xl:gap-16 2xl:gap-20 bg-brand-cream rounded-2xl lg:rounded-22px 2xl:rounded-30px overflow-hidden md:p-30px lg:p-10 2xl:p-16">
            ...
            {/* Image */}
            <div className="h-1/2 md:h-full relative md:max-w-96 lg:max-w-[518px] 2xl:max-w-[691px] z-10 left-auto lg:w-fit lg:h-full shrink-0 flex flex-col justify-between bg-white border-x border-b border-brand-gray rounded-2xl lg:rounded-30px overflow-hidden p-5 md:p-7 lg:p-10">
              <div className="space-y-5">
                <h4 className="font-felidae tracking-wider text-[32px] sm:text-[40px] lg:lg:text-6xl 2xl:text-[80px] leading-[30px] sm:leading-[38px] lg:leading-[58px] 2xl:leading-[76px]">
