const bloggers = [
  {
    img: "/public/assets/images/img-blogger-1.png",
  ...
  {
    img: "/public/assets/images/img-blogger-2.png",
    name: "Кайфория",
    nickname: "kajforia",
    followers: "38,1k",
    review:
  ...
  {
    img: "/public/assets/images/img-blogger-3.png",
    name: "Влад Романов",
    nickname: "toprvd",
    followers: "116k",
    review:
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-8 text-sm 2xl:text-lg">
                    ...
                    <div className="flex items-center gap-2">
                      <img src="/public/assets/images/icon-user.svg" alt="" />
