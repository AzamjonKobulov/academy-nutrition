  ...
  return (
    <section className="relative bg-brand-cream bg-hero-mobile xs:bg-hero bg-no-repeat xs:bg-cover bg-left-bottom sm:bg-top -mt-16 sm:-mt-20 3xl:-mt-24 pt-32 pb-0 sm:pb-20 lg:pt-40 3xl:pt-52">
      <div className="container mx-auto px-30px">
        {/* Title */}
        <h1 className="mx-auto text-[52px] xs:text-7xl md:text-[119px] lg:text-[160px] xl:text-[185px] 3xl:text-[224px] 3xl:text-[265px] font-felidae leading-[52px] xs:leading-[60px] md:leading-[119px] lg:leading-[155px] xl:leading-[180px] 3xl:leading-[15rem]">
        ...
        {/* Academies */}
        <div className="max-w-full xs:max-w-64 sm:max-w-80 md:max-w-96 lg:max-w-[439px] 3xl:max-w-auto h-8 lg:h-10 3xl:h-auto flex items-center gap-5 sm:gap-7 3xl:gap-10 mt-8 sm:mt-40 lg:mt-32 3xl:mt-24">
          <img
