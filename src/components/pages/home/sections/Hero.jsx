...
export default function Hero() {
  return (
    <section className="relative bg-brand-cream bg-hero-mobile xs:bg-hero bg-no-repeat xs:bg-cover bg-left-bottom sm:bg-top -mt-16 sm:-mt-20 2xl:-mt-24 pt-32 pb-0 sm:pb-20 lg:pt-40 2xl:pt-52">
      <div className="container mx-auto px-30px">
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:items-center justify-between gap-30px sm:gap-10 mt-7 xs:mt-10 2xl:mt-24">
          <Button
            variant="primary"
            className="sm:w-fit h-[62px] sm:h-[73px] 2xl:h-[6.3125rem] lg:text-lg 2xl:text-2xl font-medium rounded-full px-30px lg:px-12 2xl:px-16"
          >
            Начать обучение
          </Button>
