      ...
      <div className="container mx-auto space-y-30px sm:space-y-10 lg:space-y-16 2xl:space-y-20 px-30px">
        ...
        <div className="space-y-30px lg:space-y-8 2xl:space-y-12">
          ...
          <div className="grid lg:grid-cols-12 gap-30px xl:gap-10">
            ...
            <div className="group flex flex-col sm:flex-row-reverse lg:flex-col sm:gap-30px lg:gap-0 col-span-4 xl:col-span-6 bg-white rounded-22px sm:rounded-2xl lg:rounded-[22px] overflow-hidden cursor-pointer p-2.5 sm:p-30px lg:p-2.5">
              ...
              <div className="relative sm:w-[229px] sm:h-[282px] shrink-0 lg:w-full 2xl:h-[419px] rounded-xl 2xl:rounded-[26px] overflow-hidden">
                ...
                {/* Video Play Button */}
                <button className="size-20 2xl:size-[110px] shrink-0 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 xl:translate-x-0 xl:translate-y-0 xl:right-10 xl:top-10 xl:left-auto z-10 grid place-content-center bg-white/50 rounded-full group-hover:bg-brand-primary transition-all duration-300">
                  <svg
                    width="32"
                    height="48"
                    viewBox="0 0 32 48"
            ...
            <div className="group flex flex-col sm:flex-row-reverse lg:flex-col sm:gap-30px lg:gap-0 col-span-4 xl:col-span-3 bg-white rounded-22px sm:rounded-2xl lg:rounded-[22px] overflow-hidden cursor-pointer p-2.5 sm:p-30px lg:p-2.5">
              ...
              <div className="relative sm:w-[229px] sm:h-[282px] shrink-0 lg:w-full 2xl:h-[419px] rounded-xl 2xl:rounded-[26px] overflow-hidden">
                ...
                {/* Video Play Button */}
                <button className="size-20 2xl:size-[110px] shrink-0 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 grid place-content-center bg-white/50 rounded-full group-hover:bg-brand-primary transition-all duration-300">
                  <svg
                    width="32"
                    height="48"
                    viewBox="0 0 32 48"
          ...
          <div className="grid lg:grid-cols-12 items-start gap-30px xl:gap-10">
            {/* Review 4 */}
            <div className="group flex flex-col sm:flex-row-reverse lg:flex-col sm:gap-30px lg:gap-0 lg:col-span-4 h-auto bg-white rounded-22px sm:rounded-2xl lg:rounded-[22px] overflow-hidden cursor-pointer px-5 py-30px 2xl:p-10">
            ...
            <div className="lg:col-span-4 space-y-30px xl:space-y-10">
              {/* Review 5 */}
              <div className="group flex flex-col sm:flex-row-reverse lg:flex-col sm:gap-30px lg:gap-0 lg:col-span-4 bg-white rounded-22px sm:rounded-2xl lg:rounded-[22px] overflow-hidden cursor-pointer px-5 py-30px 2xl:p-10">
                {/* There is no video in this review */}
              ...
              {/* Review 7 */}
              <div className="group flex flex-col sm:flex-row-reverse lg:flex-col sm:gap-30px lg:gap-0 lg:col-span-4 col-start-4 col-end-8 bg-white rounded-22px sm:rounded-2xl lg:rounded-[22px] overflow-hidden cursor-pointer px-5 py-30px 2xl:p-10">
                {/* There is no video in this review */}
          ...
          <div className="flex items-center justify-center">
            <Button
              variant="outline"
              className="h-16 lg:h-[77px] 2xl:h-[98px] 2xl:text-22 font-medium whitespace-nowrap text-white border-white hover:bg-white hover:!text-brand-primary rounded-full px-6 lg:px-16"
            >
              Все отзывы
            </Button>
          </div>
