      ...
      <div className="container mx-auto space-y-30px sm:space-y-10 lg:space-y-16 2xl:space-y-20 px-30px">
        <div className="relative flex flex-col lg:grid grid-cols-2 gap-30px lg:gap-12 rounded-2xl lg:rounded-[44px] 2xl:rounded-[60px] overflow-hidden after:absolute after:inset-0 after:bg-black/70 sm:p-30px lg:p-[60px] 2xl:p-[90px]">
          ...
          <div className="relative z-10 h-full flex flex-col gap-30px justify-between sm:gap-0 py-30px px-5 sm:p-0">
            <div className="space-y-14 2xl:space-y-10">
              {/* Title */}
              ...
              {/* Socials */}
              <div className="lg:max-w-[280px] 2xl:max-w-[340px] flex sm:hidden lg:flex flex-col sm:flex-row lg:flex-col 2xl:items-center gap-3 lg:gap-6 font-medium">
                <a
                  href="#"
                  className="h-16 2xl:h-[76px] w-full sm:w-fit lg:w-full group flex items-center justify-center gap-3 text-white border border-white rounded-full hover:text-brand-primary hover:bg-white transition-all duration-300 px-6 2xl:px-9"
                >
          ...
          {/* Socials */}
          <div className="relative z-10 lg:max-w-[280px] 2xl:max-w-[340px] hidden sm:flex lg:hidden flex-col sm:flex-row lg:flex-col 2xl:items-center gap-3 lg:gap-6 font-medium">
            <a
              href="#"
              className="h-16 2xl:h-[76px] w-full sm:w-fit lg:w-full group flex items-center justify-center gap-3 text-white border border-white rounded-full hover:text-brand-primary hover:bg-white transition-all duration-300 px-6 2xl:px-9"
            >
