        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-5 bg-white rounded-22px overflow-hidden p-2.5 sm:p-5 lg:p-2.5 2xl:p-4">
          <div className="rounded-22px overflow-hidden">
            <img
              ...
              alt="Image"
              className="w-full sm:h-[212px] 2xl:h-80 object-cover"
            />
          </div>

          <div className="space-y-2.5 2xl:space-y-3.5 pb-3 px-2.5 lg:px-3 2xl:p-4">
            <h3 className="text-xl 2xl:text-30 font-medium 2xl:leading-10">
              Практика
            </h3>
            <p className="text-base 2xl:text-22 2xl:leading-8">
