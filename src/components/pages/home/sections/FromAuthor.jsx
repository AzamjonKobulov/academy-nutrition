export default function FromAuthor() {
  return (
    <section className="2xl:-mt-10">
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-start gap-30px 2xl:gap-24 px-30px">
        {/* Texts */}
        <div className="sm:space-y-10">
          ...
          <div className=" w-full space-y-30px">
            <div className="space-y-5">
              ...
              <ul className="list-disc space-y-3.5 sm:space-y-5 text-sm xs:text-base 2xl:text-22  pl-7">
            ...
            <div className="space-y-3.5 xs:space-y-5 text-sm xs:text-base 2xl:text-22">
              <p>
        ...
        <div className="md:max-w-[350px] lg:max-w-[780px] group flex flex-col md:flex-row-reverse lg:flex-col md:gap-30px lg:gap-0 col-span-4 xl:col-span-6 bg-white rounded-22px sm:rounded-2xl lg:rounded-[22px] overflow-hidden cursor-pointer">
          ...
          {/* Video */}
          <div className="relative rounded-xl 2xl:rounded-[26px] overflow-hidden">
