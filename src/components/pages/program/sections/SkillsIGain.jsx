const skills = [
  ...
  {
    icon: "/assets/images/icon-skill-4.svg",
      ...
      <div className="container mx-auto space-y-30px sm:space-y-10 lg:space-y-16 3xl:space-y-20 px-30px">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-5 lg:gap-10">
          {skills.map((skill, idx) => (
            <div
              key={idx}
              className="space-y-3.5 sm:space-y-5 3xl:space-y-30px bg-white rounded-2xl lg:rounded-22px 3xl:rounded-30px pt-30px pb-12  px-30px"
            >
              <img
                src={skill.icon}
                alt={skill.title}
              ...
              <div className="space-y-2">
                <h5 className="font-medium text-xl sm:text-22 3xl:text-[30px] leading-7 sm:leading-[30px] 3xl:leading-10">
                  {skill.title}
                </h5>
                <p>{skill.text}</p>
              </div>
