export default function TopPin() {
  return (
    <div className="relative z-10 flex items-center justify-center gap-2.5 bg-brand-primary text-white text-sm sm:text-base 3xl:text-lg font-semibold py-2.5">
      <img
