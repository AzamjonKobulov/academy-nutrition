        ...
        <div className="flex items-center justify-between bg-white border rounded-full px-5 py-2.5 lg:px-2.5 2xl:p-4">
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center gap-2.5 lg:mr-30px">
              <Button
                variant="outline"
                className="hidden sm:block h-12 text-lg font-medium rounded-full px-5"
              >
                +1 424 477-33-77
              </Button>
              <Button
            ...
            <div className="relative bg-white border rounded-full">
              {/* Dropdown */}
              <button
                onClick={toggleLangDropdown}
                className="min-w-16 hidden lg:flex 2xl:hidden items-center  relative z-10 gap-1 h-11 bg-brand-primary text-white text-xl font-medium rounded-full px-2.5"
              >
                {lang === 0 ? "Ru" : "En"}
                <svg
                  width="16"
