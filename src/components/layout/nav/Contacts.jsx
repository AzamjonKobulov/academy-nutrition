...
export default function Contacts() {
  return (
    <div className="flex items-center gap-2.5 lg:mr-30px">
      <a
        href="tel:"
        className="h-12 hidden xs:grid place-content-center sm:text-lg font-medium rounded-full text-brand-primary border border-brand-primary hover:bg-brand-primary hover:text-white transition-all duration-300 px-5"
      >
        +1 424 477-33-77
      </a>
      <Button
